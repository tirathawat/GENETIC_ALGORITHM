...
func main() {
	...
	// arr1 := filterAddress(address, 0)
	// destinations1 := getDestinations(arr1)
	// arr2 := filterAddress(address, 10)
	// destinations2 := getDestinations(arr2)
	// arr3 := filterAddress(address, 20)
	// destinations3 := getDestinations(arr3)
	// arr4 := filterAddress(address, 30)
	...
	// _ = ioutil.WriteFile("data_lat_lon.json", file, 0644)
}
...
func filterAddress(address []string, offset int) []string {
